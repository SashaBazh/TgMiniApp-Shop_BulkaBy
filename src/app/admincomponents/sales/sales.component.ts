...
export class SalesComponent implements OnInit {
  ...
  constructor(
    ...
    this.discountForm = this.fb.group({
      ...
      discount_percentage: [0, [Validators.required, Validators.min(0), Validators.max(1)]],
      start_date: [''],
      end_date: [''],
      product_id: [''],
      category_id: [''],
    ...
    if (this.discountForm.valid) {
      ...
      const discountData = {
        ...
        end_date: formValue.end_date
          ...
          : null,
        product_id: formValue.product_id ? parseInt(formValue.product_id, 10) : null,
        category_id: formValue.category_id ? parseInt(formValue.category_id, 10) : null,
      };
      ...
      if (this.isEditing && this.editingDiscountId) {
        // Обновление скидки
        this.discountsService.updateDiscount(this.editingDiscountId, discountData).subscribe({
          next: () => {
