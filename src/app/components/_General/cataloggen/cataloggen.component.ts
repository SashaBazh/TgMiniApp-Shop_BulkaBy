...
import { CatalogItem2Component } from '../catalog-item2/catalog-item2.component';

@Component({
  selector: 'app-cataloggen',
  standalone: true,
  imports: [CommonModule, CatalogItem2Component],
  templateUrl: './cataloggen.component.html',
  styleUrls: ['./cataloggen.component.css'],
})

export class CataloggenComponent implements OnInit {
